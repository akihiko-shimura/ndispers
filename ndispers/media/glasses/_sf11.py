...
class SF11(Medium):
    """
    SF11 (SCHOTT dense flint glass)

    - Amorphous, optically isotropic
    - Transparency range : about 0.39 to 2.5 µm
    - High-dispersion lead-silicate flint; the usual material of prism-pair pulse compressors (n_d = 1.78472)
    ...
    Validity range
    ---------------
    0.39 to 2.5 µm, at 20 degC (catalog data, relative to air)
    ...
    ---
    Sellmeier equation:
      SCHOTT SF11 (vendor data, Zemax catalog 2017-01-20b, accessed 2026-08-23 via refractiveindex.info specs/schott/optical/SF11). https://www.schott.com/en-us/products/optical-glass-p1000267/downloads/
    """
    _wl_range = (0.39, 2.5)  # um, Sellmeier validity (see docstring)
    ...
    def __init__(self):
        ...
        self._B1 = 1.73848403
        self._C1 = 0.0136068604
        self._B2 = 0.311168974
        self._C2 = 0.0615960463
        self._B3 = 1.17490871
        self._C3 = 121.922711
